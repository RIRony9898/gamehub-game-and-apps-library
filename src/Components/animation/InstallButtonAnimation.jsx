...
export default function InstallButtonAnimation({ isOpen, onClose }) {
  ...
  if (isOpen) {
    console.log("DEBUG: InstallButtonAnimation is rendering with isOpen = true");
  }
      ...
      <Dialog.Root open={isOpen} onOpenChange={onClose}>
        <Dialog.Portal forceMount>
          {transition((style, item) =>
            item ? (
              <OverlayBackground style={{ opacity: style.opacity }} onClick={onClose} />
            ) : null
          )}
          {transition((style, item) =>
            item ? (
              <Content forceMount style={style}>
                  ...
                  <Dialog.Description>Your software has been successfully installed.</Dialog.Description>
                </Content>
            ) : null
          )}
        </Dialog.Portal>
